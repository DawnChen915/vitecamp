<template>
  <!-- <echart :option="option" :loop="loop"></echart> -->
  <div id="chart" style="height: 1000px;width:1100px"></div>
...
// 圆形分区
const CalutePointToSplitCircle = (arr, option) => {
  const newArray = [];
...
const getOption = (startAngle, radius) => {
  let option = {
